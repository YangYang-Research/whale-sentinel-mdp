...
@section('dashboard')
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Update Instance</h1>

<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Update Your Instance</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('instance.update', ['instance' => $instance]) }}" method="post">
            @csrf
            @method('PUT')
